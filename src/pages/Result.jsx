    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
              ...
              <Grid item xs={12} sm={6}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                  ...
                  <Typography variant="body1">
                    ...
                    {hasDiemLietWrong ? "Không đạt" : "Đạt"}
                  </Typography>
                </Box>
              </Grid>
            </>
          ...
          {hasDiemLietWrong && (
            <Alert severity="error" sx={{ mb: 3 }}>
              <Typography variant="body2">
                <strong>Chú ý:</strong> Bạn đã sai {diemLietWrongCount} câu điểm
                liệt. Đây là lý do chính khiến bạn không đạt bài thi.
              </Typography>
            </Alert>
          )}
              ...
              >
                <CardContent>
                  ...
                  <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
                    <Typography
                      variant="body2"
                      color={answer.isCorrect ? "success.main" : "error"}
                    >
      ...
      {!isPassed && (
        <Alert severity="info" sx={{ mt: 4 }}>
          <Typography variant="body2">
            <strong>Gợi ý:</strong> Hãy sử dụng chế độ "Ôn tập câu sai" để tập
            trung vào những câu hỏi bạn đã trả lời sai. Điều này sẽ giúp bạn cải
            thiện kết quả trong lần thi tiếp theo.
          </Typography>
        </Alert>
      )}
      <SoundControl />
